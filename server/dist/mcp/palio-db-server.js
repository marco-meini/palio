...
import { findObjects, initPostgresCliPool, listTables, runQuery, schemaInspect, } from '../lib/postgres-cli.js';
...
async function main() {
    ...
    server.registerTool('run_palio_recipe', {
    ...
    server.registerTool('run_readonly_sql', {
...
//# sourceMappingURL=palio-db-server.js.map