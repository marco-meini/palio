...
import { pgFindObjects, pgListTables, pgProfileTest, pgRunQuery, pgSchemaInspect, } from './pg-readonly-driver.js';
...
const FORBIDDEN_KEYWORD = /\b(INSERT|UPDATE|DELETE|DROP|ALTER|CREATE|TRUNCATE|GRANT|REVOKE|migration)\b/i;
