 ...
 * @param {ReturnType<typeof parsePalioPage>} sommario
 * @param {ReturnType<typeof parseIngressoCanape>} canapeRows
 * @param {Map<string, number>} contradeByName
 * @param {Map<string, { ordine: number, estratta: boolean, estrattaDaName?: string }>|null} ordineByCode
 * @param {Map<string, { ordineAssegnazione: number, orecchio: number, coscia: number, proprietarioCavallo: string, cavalloPresoDa: string }>|null} assegnazioneByCode
 * @param {Map<string, number>|null} arrivoByCode
 * @param {Map<string, { capitano?: string, priore?: string, barbaresco?: string, mangini: string[] }>|null} dirigenzeByCode
 */
...
async function main() {
  ...
  try {
    ...
    while (url && fetched < opts.max) {
      ...
      /** @type {Map<string, { capitano?: string, priore?: string, barbaresco?: string, mangini: string[] }>|null} */
      ...
      /** @type {Map<string, { ordine: number, estratta: true, estrattaDaName?: string }>|null} */
      ...
      /** @type {Map<string, { ordineAssegnazione: number, orecchio: number, coscia: number, proprietarioCavallo: string, cavalloPresoDa: string }>|null} */
