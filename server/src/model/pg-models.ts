...
export class PgModels {
  readonly palii: ModelPalii;
  readonly cavalli: ModelCavalli;
  readonly fantini: ModelFantini;
  readonly paliiContrade: ModelPaliiContrade;
...
export class Model {
  pgClient: PgClientManager;
  __modelPalii: ModelPalii;
  __modelCavalli: ModelCavalli;
  __modelFantini: ModelFantini;
  __modelPaliiContrade: ModelPaliiContrade;
